...
namespace SignService.Common.HashSignature.Xml
{
	public class DsigSignature
	{
		...
		public static XmlNode CreateSignature(MessageDigestAlgorithm alg, DateTime signTime, string base64Digest, string base64SignatureValue, string subjectDN, string base64Cert, string rsaKeyValue, string signatureId = "sigid", string referenceUri = "", string signTimeID = "AddSigningTime")
		{
		...
		public static XmlNode CreateSignature(MessageDigestAlgorithm alg, DateTime signTime, List<string> listReference, string base64SignatureValue, string subjectDN, string base64Cert, string rsaKeyValue, List<string> listUri, string signatureId = "sigid", string signTimeID = "AddSigningTime")
		{
			XmlDocument xmlDocument = new XmlDocument();
			XmlNode xmlNode = xmlDocument.CreateElement("Signature");
			XmlAttribute xmlAttribute = xmlDocument.CreateAttribute("Id");
